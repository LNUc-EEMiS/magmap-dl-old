...
**nf-core/magmap** is a bioinformatics best-practice analysis pipeline for Nextflow (nf-core) workflow for mapping reads to large collections of genomes..
...
nf-core/magmap was originally written by Daniel Lundin.
